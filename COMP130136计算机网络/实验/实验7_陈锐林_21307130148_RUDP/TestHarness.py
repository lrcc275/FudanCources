...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, SackRandomDropTest,BadOrderTest,RepeatTest
    #BasicTest.BasicTest(forwarder, "README")
    RandomDropTest.RandomDropTest(forwarder, "README")
    BadOrderTest.BadOrderTest(forwarder,"README")
    RepeatTest.RepeatTest(forwarder,"README")
